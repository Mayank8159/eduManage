...
import type { IMark } from "../models/Mark";

export function teacherPerformanceScore(input: {
...
export function simulateStudentInsights(attendanceRecords: IAttendance[], marks: IMark[]) {
